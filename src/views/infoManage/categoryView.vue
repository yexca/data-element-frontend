  ...
  <div class="app-container">
    ...
    <!-- <div class="content-header" style="display: flex; "> -->
      <div class="content-header-search" style="display: flex; align-items: center;">
        ...
        <el-input v-model="queryParams.categoryId" :placeholder="$t('placeholder.id')" clearable style="width: 110px;"></el-input>
        ...
        <el-input :placeholder="$t('placeholder.phoneCode')" v-model="queryParams.description" clearable style="width: 150px"></el-input>
    ...
    <div class="content-main">
      ...
      <el-table
        ...
        stripe
      >
        <el-table-column prop="categoryId" :label="$t('form.id')" width="60" sortable fixed="left">
        </el-table-column>
        <el-table-column prop="name" :label="$t('form.name')" width="180" sortable align="center">
        </el-table-column>
        <el-table-column prop="description" :label="$t('form.description')" width="100" sortable align="center">
        </el-table-column>
    ...
    >
      <el-form ref="formRef" status-icon :model="form" :rules="rules" label-width="100px" class="drawer-form">
        ...
        <el-form-item :label="$t('form.description')" prop="phone">
    ...
    return {
      ...
      rules :{
        name: [
          ...
          { pattern: /^[\u4e00-\u9fff\u3040-\u30ff\uac00-\ud7afA-Za-z0-9\s]+$/, message: this.$t('errorMessage.nameLimit'), trigger: 'blur'}
        ],
        description: [
          {required: true, message: this.$t('errorMessage.description'), trigger: 'blur'},
          { pattern: /^[\u4e00-\u9fff\u3040-\u30ff\uac00-\ud7afA-Za-z0-9\s]+$/, message: this.$t('errorMessage.descriptionLimit'), trigger: 'blur'}
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCategory(categoryId).then((res) => {
        ...
        // 显示右侧抽屉
        this.dialogTitle = this.$t('formTitle.updateCategory');
    ...
    handleAdd(){
      this.reset();
      this.dialogTitle = this.$t('formTitle.addCategory');
      this.openDialog = true
    },
    // 删除按钮操作
    handleDelete(row){
