<template>
  ...
  <div class="layout-container">
    ...
    <el-card class="info-card" shadow="hover">
      <div slot="header" class="header">{{ $t('userView.personalTitle') }}</div>
      ...
      <el-row :gutter="20">
        ...
        >
        <el-col :span="8"
          ><strong>{{ $t('userView.nickname') }}</strong> {{ userInfo.nickname }}</el-col
        >
      </el-row>
      <el-row :gutter="20">
        <el-divider>{{ $t('userView.personalInfo') }}</el-divider>
        <el-col :span="8"><strong>{{ $t('userView.gender') }}</strong> {{ userInfo.gender }}</el-col>
        <el-col :span="8"
    ...
    <!-- 个人信息修改弹窗 -->
    <el-dialog :title="$t('formTitle.updatePersonalUser')" width="30%" :visible.sync="openDialog" >
      <el-form
        ref="userForm"
        :model="userForm"
        :rules="userRules"
      ...
      >
        <el-form-item :label="$t('form.username')" prop="username">
          <el-input disabled v-model="userForm.username" :placeholder="$t('placeholder.username')" />
        </el-form-item>
    ...
    <!-- 国家或地区选择 -->
        ...
        <el-form-item :label="$t('form.nin')" prop="nin">
          <el-input v-model="userForm.nin" :placeholder="$t('placeholder.nin')" />
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        ...
        <el-form-item :label="$t('form.description')" prop="description">
          <el-input type="textarea" v-model="form.description" :placeholder="$t('placeholder.description')" />
        </el-form-item>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getPersonalData(dataId).then((res) => {
        ...
        // 显示右侧抽屉
        this.drawerTitle = this.$t('formTitle.updatePersonalData');
